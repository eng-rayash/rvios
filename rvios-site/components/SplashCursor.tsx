...
const SplashCursor: React.FC<SplashCursorProps> = ({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      let gl = canvasEl.getContext('webgl2', params) as any;
      const isWebGL2 = !!gl;
  ...
  return (
    <div className="fixed top-0 left-0 z-[9999] pointer-events-none w-full h-full overflow-hidden">
      <canvas ref={canvasRef} id="fluid" className="w-screen h-screen block pointer-events-none" />
    </div>
  );
};
