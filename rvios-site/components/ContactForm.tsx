...
export default function ContactForm() {
  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center justify-center text-center py-16 px-8 rounded-2xl bg-white border border-black/7 shadow-card">
        ...
        <h3 className="font-display text-2xl text-ink mb-2">تم الإرسال بنجاح!</h3>
        <p className="font-body text-sm text-ink-muted mb-1">Message sent successfully</p>
        <p className="font-body text-sm text-ink-muted mt-3 max-w-xs">
  ...
  return (
    ...
    >
      {/* Name */}
      <div>
        <label htmlFor="name" className="block font-body text-xs tracking-[0.15em] uppercase text-ink-muted mb-1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="email" className="block font-body text-xs tracking-[0.15em] uppercase text-ink-muted mb-1.5">
        ...
        <div>
          <label htmlFor="phone" className="block font-body text-xs tracking-[0.15em] uppercase text-ink-muted mb-1.5">
      ...
      {/* Service Type */}
      <div>
        <label htmlFor="serviceType" className="block font-body text-xs tracking-[0.15em] uppercase text-ink-muted mb-1.5">
      ...
      {/* Message */}
      <div>
        <label htmlFor="message" className="block font-body text-xs tracking-[0.15em] uppercase text-ink-muted mb-1.5">
      ...
      {error && (
        <p
          role="alert"
          className="rounded-xl border border-primary/30 bg-primary/5 px-4 py-3 font-body text-sm text-primary"
        >
          {error}
        </p>
      )}
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full py-3.5 font-body text-sm font-bold transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed hover:shadow-lg"
        >
