...
2. المفتاح **في تاريخ git** منذ commit `3d49105` — على `github.com/eng-rayash/Mudiri-app`
   وهو **عام**، لا على `Mudiri` الخاص كما ذُكر هنا خطأً. وهو في أحدث نسخة من
   الملف لا في التاريخ فحسب.

   **تحديث 2026-08-29:** مشروع Supabase المقصود (`psjlycjbaiacdzvtewvi`) **محذوف** —
   نطاقه لا يُحلّ في DNS. فالمفتاح باطل ولم يعد يفتح شيئاً. يبقى حذف السطر
   ومعالجة المستودع العام مسألة نظافة. انظر [SECURITY.md](SECURITY.md).
